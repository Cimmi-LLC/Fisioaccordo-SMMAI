...
const AI_MODEL_SETS: Record<string, string[]> = { "stock": [], "nano-2": ["gemini-3.1-flash-image", "gemini-3-pro-image", "gemini-2.5-flash-image"], "nano-pro": ["gemini-3-pro-image", "gemini-3.1-flash-image", "gemini-2.5-flash-image"], "gpt-2": ["gpt-image-2", "gemini-3.1-flash-image", "gemini-2.5-flash-image"] };

    ...
    <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm mb-8">
      <CardHeader>
        <CardTitle className="text-white flex items-center text-base sm:text-lg">
          <Lightbulb className="h-5 w-5 mr-2 text-yellow-400 flex-shrink-0" />
          💡 Sei a corto di idee?
        </CardTitle>
      </CardHeader>
      <CardContent>
        <div className="flex flex-col sm:flex-row gap-4">
          <Input
            ...
            className="bg-gray-700 border-gray-600 text-white flex-1 text-sm sm:text-base min-h-[44px]"
          />
          <Button 
            onClick={generateIdea}
            className="bg-purple-600 hover:bg-purple-700 px-4 sm:px-6 py-2 min-h-[44px] whitespace-nowrap"
          >

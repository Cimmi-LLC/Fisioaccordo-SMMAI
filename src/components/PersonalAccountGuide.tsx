    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Convertire il tuo account è gratuito, ci vogliono 30 secondi e non perdi nulla.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-5 mt-2">
          ...
          <div className="rounded-lg border border-green-500/30 bg-green-500/5 p-4 space-y-2">
            ...
            <ul className="text-sm text-muted-foreground space-y-1.5">
              <li className="flex items-center gap-2"><Users className="h-4 w-4 shrink-0" /> I tuoi follower restano</li>
              <li className="flex items-center gap-2"><Image className="h-4 w-4 shrink-0" /> I tuoi post e storie restano</li>
              <li className="flex items-center gap-2"><MessageCircle className="h-4 w-4 shrink-0" /> I tuoi messaggi restano</li>
              <li className="flex items-center gap-2"><UserCheck className="h-4 w-4 shrink-0" /> La tua bio e foto profilo restano</li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ol className="space-y-2.5 text-sm text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>Vai su <strong className="text-foreground">Impostazioni → Privacy</strong> <ArrowRight className="inline h-3 w-3" /> disattiva <strong className="text-foreground">"Account privato"</strong> <Globe className="inline h-3.5 w-3.5" /></span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Torna qui e clicca <strong className="text-foreground">"Collega Instagram Business"</strong></span>
              </li>
            </ol>
          </div>

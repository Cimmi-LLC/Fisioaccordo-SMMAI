      ...
      <div className="max-w-3xl mx-auto bg-card rounded-lg border border-border p-8 space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            FisioAccordo(VIRAL)ContentAI ("the Service") is a social media content generation platform 
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <a href="mailto:support@cimmi.co" className="text-primary hover:underline">support@cimmi.co</a>
          </p>
        </section>
